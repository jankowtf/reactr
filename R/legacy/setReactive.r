...
#' See main method 
#' \code{\link{setReactive-character-ANY-environment-character-environment-call-method}}
#' 
#' @details
...
#' @param binding \code{\link{missing}}.
#' @return See method
#'    \code{\link[reactr]{setReactive-character-ANY-environment-character-missing-call-method}}.
#' @example inst/examples/setReactive.r
#' @seealso \code{
#'    Generic: \link[reactr]{setReactive}
#' }
