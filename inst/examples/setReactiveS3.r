...
setReactiveS3(id = "x_2", value = function(deps = list(x_1 = where)) {x_1},
              where = where)
setReactiveS3(id = "x_2", value = function() {
  .react_1 = get(id = "x_1", envir = where)
  .react_1
}, where = where)
...
setReactiveS3(id = "x_2", watch = "x_1", binding = function(x) {x})
...
## Set variable that monitors 'x_1' //
setReactiveS3(id = "x_3", where = where, watch = "x_1", binding = function(x) {x + 100})
...
setReactiveS3(id = "x_3", watch = "x_1", binding = function(x) {x + 100})
...
setReactiveS3(id = "x_1", where = where, watch = "x_2", 
  mutual = TRUE, .tracelevel = .tracelevel)
setReactiveS3(id = "x_2", where = where, watch = "x_1", 
  mutual = TRUE, .tracelevel = .tracelevel
)
...
setReactiveS3(id = "x_1", watch = "x_2", mutual = TRUE, .tracelevel = .tracelevel)
setReactiveS3(id = "x_2", watch = "x_1", mutual = TRUE, .tracelevel = .tracelevel)
...
setReactiveS3(id = "x_3", where = where, watch = "x_2", 
...
setReactiveS3(id = "x_1", watch = "x_2", mutual = TRUE, .tracelevel = .tracelevel)
setReactiveS3(id = "x_2", watch = "x_1", mutual = TRUE, .tracelevel = .tracelevel)
setReactiveS3(id = "x_3", watch = "x_2", binding = function(x) {x + 100}, 
...
## Set variables that are mutually bound //
setReactiveS3(id = "x_1", watch = "x_2", mutual = TRUE, 
  binding = function(x) {x/2}, .tracelevel = .tracelevel)
setReactiveS3(id = "x_2", watch = "x_1", mutual = TRUE, 
  binding = function(x) {x * 2}, .tracelevel = .tracelevel
)
...
setReactiveS3(id = "field_2", value = data.frame(x_1 = 1:5, x_2 = letters[1:5]), 
  where = x_1)

## Set variable with bindings //
setReactiveS3(id = "field_1", where = x_2, watch = "field_1", where_watch = x_1, 
         binding = function(x) {!x})
setReactiveS3(id = "field_2", where = x_2, watch = "field_2", where_watch = x_1, 
...
setReactiveS3(id = "x_1", value = 10, where = where, .hash_id = new_hash_id)
...
setReactiveS3(id = "x_1", value = Sys.time(), where = where, binding_type = 2)
getReactive(id = "x_1", where = where)

binding <- substitute(function(x) {
  x + 60*60*24
})
setReactiveS3(id = "x_2", where = where, binding = binding, watch = "x_1", 
         binding_type = 2)
...
setReactiveS3(id = "x_1", value = Sys.time(), binding_type = 2)
getReactive(id = "x_1")

binding <- substitute(function(x) {
  x + 60*60*24
})
setReactiveS3(id = "x_2", binding = binding, watch = "x_1", binding_type = 2)
getReactive(id = "x_2")  
...
res_bt_1 <- microbenchmark(
  "1" = setReactiveS3_bare(id = "x_1", value = 10, where = where),
  "2" = getReactive(id = "x_1", where = where),
  "3" = setReactiveS3_bare(id = "x_2", where = where, watch = "x_1",
    binding = function(x) {x + 100}),
  "4" = getReactive(id = "x_2", where = where),
  "5" = setReactiveS3_bare(id = "x_1", value = 100, where = where),
...
res_bt_2 <- microbenchmark(
  "1" = setReactiveS3_bare(id = "x_1", value = Sys.time(), where = where,
                 binding_type = 2),
  "2" = getReactive(id = "x_1", where = where),
  "3" = setReactiveS3_bare(id = "x_2", where = where,
    binding = substitute(function(x) {
        x + 60*60*24
      }), watch = "x_1", binding_type = 2),
  "4" = getReactive(id = "x_2", where = where),
  "5" = setReactiveS3_bare(id = "x_1", value = Sys.time(), where = where,
                 binding_type = 2),
  "6" = getReactive(id = "x_2", where = where),
  control = list(order = "inorder")
)
