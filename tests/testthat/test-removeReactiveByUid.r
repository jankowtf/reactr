context("removeReactiveByUid/basics")
test_that("removeReactiveByUid/strict_get=0", {
...
test_that("removeReactiveByUid/strict_get=1", {
...
test_that("removeReactiveByUid/strict_get=2", {
